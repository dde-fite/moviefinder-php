...
<head>
    <meta charset="UTF-8">
    <title>ENCUENTRA tu Nueva PELICULA | MovieFinder</title>
        ...
        <div class="container mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a class="text-gray-900" href="?votes=TRUE">
                        Mas Votadas
                    </a>
    ...
    <section class="container mx-auto py-6 px-4 md:px-6">
        <div class="grid md:grid-cols-[240px_1fr] gap-10 items-start">
            <div class="flex flex-col gap-4 items-start py-2">
                ...
                <div class="grid gap-2 mb-5">
                    <label class="font-medium peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-base" for="year">
                        Year
                    </label>
                    <input
                        <?php
                ...
                <div class="grid gap-2 mb-5">
                    ...
                    <div class="grid grid-cols-3">
                        <div class="p-3">
                            <input type="radio" name="country" value="" id="none-country" class="absolute opacity-0 w-0 h-0">
                            <label for="none-country"><img style="height:27px;"  src="img/redcross.png" class="cursor-pointer pais-select"></label>
                        </div>
                    <?php
                ...
                <div class="grid gap-2 mb-5">
                    <label class="font-medium peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-base" for="age">
                        Age
                    </label>
                    ...
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Enviar</button>
                </form>
            </div>
    ...
    <section class="bg-white">
        <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
            <nav class="flex flex-wrap justify-center -mx-5 -my-2">
                <div class="px-5 py-2">
                    <a href="dashboard.php" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                        Zona Privada
                    </a>
                </div>
            </nav>
            ...
            <p class="mt-8 text-base leading-6 text-center text-gray-400">
                © 2023 MovieFinder, Inc. All rights reserved.
            </p>
        </div>
    </section>
</main>
